  ...
  const benefits = [
    {
      ...
      description: 'Запускаем вашего персонального AI-ассистента всего за 24 часа без сложных настроек'
    },
    {
      icon: Globe,
      title: '💬 Поддержка 10+ языков',
      description: 'Включая региональные языки Центральной Азии: узбекский, таджикский, казахский и другие'
    },
    {
      icon: Shield,
      title: '🔒 Соответствие законодательству',
      description: 'Хранение данных в соответствии с локальным законодательством Узбекистана и региона'
    },
    {
      icon: Target,
      title: '📈 Рост эффективности на 40–60%',
      description: 'Измеримое улучшение клиентского сервиса и сокращение времени обработки запросов'
    },
    {
      icon: Users,
      title: '💡 Простой запуск без программирования',
      description: 'Интуитивная платформа, которая не требует технических знаний от пользователей'
    },
    {
      icon: Clock,
      title: '⚡ Мгновенные ответы 24/7',
      description: 'Ваши клиенты получают профессиональную помощь в любое время дня и ночи'
    }
  ];
